      ...
      <div className="mt-20 mb-10 max-w-6xl mx-auto">
        ...
        <div className="mt-10 flex justify-center items-center space-x-8">
          <span className="flex items-center text-sm">
            <svg className="h-6 w-auto mr-2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path d="M23 5a4 4 0 00-4-4H5a4 4 0 00-4 4v14a4 4 0 004 4h14a4 4 0 004-4V5zm-1 14a3 3 0 01-3 3H5a3 3 0 01-3-3V5a3 3 0 013-3h14a3 3 0 013 3v14z" fill="currentColor"/>
              <path d="M9.343 9.55l-.949 4.9h1.535l.949-4.9H9.343zm6.335 3.138l.808-2.234.466 2.234h-1.274zm2.442.746l1.132 1.016h1.535l-1.85-1.693 1.85-3.207h-1.483l-1.132 2.031-.36-2.031h-2.8l-.412 1.01a2.038 2.038 0 00-1.641-.86c-1.751 0-3.029 1.85-3.029 4.054 0 1.303.772 2.099 1.952 2.099.591 0 1.209-.254 1.692-.687l-.157.636h1.38l1.277-6.252h1.397l.052 3.9zm-4.522.238c-.643 0-1.018-.466-1.018-1.209 0-1.209.617-2.002 1.483-2.002.643 0 1.043.492 1.043 1.208 0 1.235-.644 2.003-1.508 2.003zm-6.05-.238l.808-2.234.466 2.234H7.548zm2.442.746l1.12 1.016h1.548l-1.85-1.693 1.85-3.207h-1.483l-1.132 2.031-.359-2.031h-2.8l-.411 1.01a2.038 2.038 0 00-1.641-.86c-1.751 0-3.029 1.85-3.029 4.054 0 1.303.771 2.099 1.951 2.099.591 0 1.21-.254 1.692-.687l-.157.636h1.38l1.277-6.252h1.397l.052 3.9zm-4.521.238c-.644 0-1.018-.466-1.018-1.209 0-1.209.617-2.002 1.483-2.002.643 0 1.043.492 1.043 1.208 0 1.235-.644 2.003-1.508 2.003z" fill="#1976D2"/>
            </svg>
            Visa
          </span>
          <span className="flex items-center text-sm">
            <svg className="h-6 w-auto mr-2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path d="M11.343 12a4.657 4.657 0 1 1 0 0zm-6.657 0a4.657 4.657 0 1 1 0 0zM12 12a4.657 4.657 0 1 1 0 0zm6.657 0a4.657 4.657 0 1 1 0 0z" fill="#FF9800"/>
              <path d="M12 18.657a4.657 4.657 0 1 1 0-9.314v9.314z" fill="#FF9800"/>
              <path d="M12 5.343a4.657 4.657 0 1 1 0 9.314V5.343z" fill="#D50000"/>
            </svg>
            Mastercard
          </span>
          <span className="flex items-center text-sm">
            <svg className="h-6 w-auto mr-2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path d="M20.205 7.91c-.276-.105-.594-.167-.928-.193a14.6 14.6 0 0 0-1.371-.026H9.322c-.188 0-.37.025-.536.062-.453.1-.717.327-.781.7-.194 1.157-.407 2.374-.617 3.596l-.467 2.706-.127.73c-.014.103-.036.207-.05.312-.08.471.287.758.75.81a1.34 1.34 0 0 0 .272.018h2.98c.61 0 .713-.465.779-.823l.036-.195.318-2.033.02-.106c.065-.359.325-.823.935-.823h.591c3.824 0 6.83-.778 7.7-3.025.367-.946.177-1.734-.419-2.297a2.698 2.698 0 0 0-.746-.517z" fill="#27346A"/>
              <path d="M9.17 8.364c.048-.311.242-.541.504-.669a1.34 1.34 0 0 1 .536-.062h6.584c.78 0 1.505.05 2.17.16.175.03.345.065.509.106.163.04.321.087.474.14a3.135 3.135 0 0 0-.81-2.286c-.89-.98-2.48-1.485-4.523-1.485H8.91c-.61 0-1.13.395-1.221.975L4.96 17.399c-.071.456.28.866.748.866h3.098L9.17 8.364z" fill="#27346A"/>
            </svg>
            PayPal
          </span>
          <span className="flex items-center text-sm">
            <svg className="h-6 w-auto mr-2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path d="M6.25 0C4.915 0 4 1.03 4 2.25v19.495C4 22.97 4.915 24 6.25 24h11.5c1.335 0 2.25-1.03 2.25-2.25V2.25C20 1.03 19.085 0 17.75 0H6.25zm.68 1.5h9.64c.473 0 .857.384.857.857v19.286a.857.857 0 01-.857.857H6.93a.857.857 0 01-.857-.857V2.357c0-.473.384-.857.857-.857zM12 21.75a1.125 1.125 0 100-2.25 1.125 1.125 0 000 2.25zm-3.273-8.25h6.545c.402 0 .728.326.728.728v6.09a.728.728 0 01-.728.728H8.727a.728.728 0 01-.727-.729v-6.09c0-.401.326-.727.727-.727zm-1.584-6h9.713c.318 0 .577.26.577.577v3.846c0 .318-.259.577-.577.577H7.143a.578.578 0 01-.577-.577V8.077c0-.318.26-.577.577-.577z" 
